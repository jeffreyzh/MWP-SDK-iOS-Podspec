#
#  Be sure to run `pod spec lint MWP-iOS-Open.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "gairui"
  # s.authors            = { "gairui" => "gairui@mogujie.com" }
  # s.social_media_url   = "http://twitter.com/gairui"
